...
const AvatarUploader = ({ currentUrl }: { currentUrl?: string }) => {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={onPick}
        className="absolute -bottom-1 -right-1 rounded-full bg-emerald-600 p-1 text-white shadow hover:bg-emerald-700"
        title="Change avatar"
        disabled={uploading}
      >
